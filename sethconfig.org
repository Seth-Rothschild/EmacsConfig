...
#+end_src
Additionally, I'll set up some Hydras for modes that I use regularly. Here is one for =org=:
#+begin_src emacs-lisp :tangle yes
(defhydra orghydra (:exit t)
  "Hydra for Org"
  ("a" org-agenda "agenda")
  ("c" org-capture "capture")
  ("ls" org-store-link "store link")
  ("li" org-insert-link "insert link")
  ("t" org-todo "org-todo" :exit nil)
  ("<left>" org-metaleft :exit nil)
  ("<right>" org-metaright :exit nil)
  ("q" nil)
)
(key-chord-define-global "jk" 'orghydra/body)
