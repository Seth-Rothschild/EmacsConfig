...
(setq hydra-org/hint
  '(prog1 (eval (hydra--format nil '(nil nil :hint nil) "\n" hydra-org/heads))
    ...
    (if (equal major-mode 'latex-mode)
      (progn
        (define-key hydra-org/keymap "cc" 'hydra-org/TeX-command-master)
        (define-key hydra-org/keymap "cv" 'hydra-org/Tex-view)
        (define-key hydra-org/keymap "ce" 'hydra-org/LaTeX-environment)
        (define-key hydra-org/keymap "cs" 'hydra-org/LaTeX-section)
      )
      (progn
        (define-key hydra-org/keymap "cc" nil)
        (define-key hydra-org/keymap "cv" nil)
        (define-key hydra-org/keymap "ce" nil)
        (define-key hydra-org/keymap "cs" nil)
      )
    )
  )
)
